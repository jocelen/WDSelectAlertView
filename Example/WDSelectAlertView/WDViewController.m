...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (section == 0) {
        ...
        NSArray * selects = row == 3 ? @[@"温馨提示:这是一条温馨提示,需要换行展示。温馨提示:这是一条温馨提示,需要换行展示。展示换行成功",@"关关雎鸠",@"在河之洲",@"窈窕淑女",@"君子好逑",@"参差荇菜",@"不可选",@"左右流之",@"窈窕淑女",@"寤寐求之",@"关关雎鸠",@"在河之洲",@"窈窕淑女",@"君子好逑",@"参差荇菜",@"不可选",@"左右流之",@"窈窕淑女",@"寤寐求之",@"关关雎鸠",@"在河之洲",@"窈窕淑女",@"君子好逑",@"参差荇菜",@"不可选",@"左右流之",@"窈窕淑女",@"寤寐求之"] : @[@"拍照",@"不可选",@"图片"];
        NSInteger selectIndex = row == 2 ? 0 : -1;
        [self showSheetSelect:title selectItems:selects selectedIndex:selectIndex disAbleItems:@[@"不可选"] selectAction:^(NSInteger index) {
            NSLog(@"%ld",index);
        }];
