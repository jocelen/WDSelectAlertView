...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (section == 0) {
        ...
        NSArray * selects = row == 2 ? @[@"温馨提示",@"关关雎鸠",@"在河之洲",@"窈窕淑女",@"君子好逑",@"参差荇菜",@"不可选",@"左右流之",@"窈窕淑女",@"寤寐求之",@"关关雎鸠",@"在河之洲",@"窈窕淑女",@"君子好逑",@"参差荇菜",@"不可选",@"左右流之",@"窈窕淑女",@"寤寐求之",@"关关雎鸠",@"在河之洲",@"窈窕淑女",@"君子好逑",@"参差荇菜",@"不可选",@"左右流之",@"窈窕淑女",@"寤寐求之"] : @[@"拍照",@"不可选",@"图片"];
